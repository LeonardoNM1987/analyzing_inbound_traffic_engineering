...
output_folder = '06-ases_policies/v6_ases'
...
for file in sorted(os.listdir(input_folder)):
    if file.startswith('v6_prefixes_policies_complete_') and file.endswith('.txt'):
        ...
        current_date = file[len('v6_prefixes_policies_complete_'):-len('.txt')]
        output_file = os.path.join(output_folder, f'v6_ases_policies_{current_date}.txt')

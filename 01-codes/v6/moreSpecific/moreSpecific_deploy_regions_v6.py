...
def compile_results(input_dir, output_path):
    ...
    input_files = glob.glob(os.path.join(input_dir, 'v6_moreSpecific_ases_details_*.txt'))
...
output_path_compile = '19-preparing_data_for_plot/v6/moreSpecific/more_specific_deploy_regions.txt'

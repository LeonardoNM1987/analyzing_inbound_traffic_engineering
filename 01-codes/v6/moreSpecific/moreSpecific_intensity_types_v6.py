...
def analyze_prefix_disaggregation(input_directory, output_filepath):
    results = defaultdict(lambda: defaultdict(lambda: [0, 0, 0, 0]))  # {as_type: {date: [disagg_1, disagg_2, disagg_3, disagg_4plus]}}
...
# Output file path
output_filepath = '19-preparing_data_for_plot/v6/moreSpecific/moreSpecific_intensity_types.txt'

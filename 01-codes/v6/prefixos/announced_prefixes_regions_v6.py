# ESSE CÓDIGO GERA UMA LISTA DE ASES ANUNCIANDO PREFIXOS IPV6 SEGMENTADOS POR REGIÃO EM NUMERO ABSOLUTO

import os

# Caminho para os arquivos de entrada e saída
input_folder = '05-prefixes_policies_regions_and_types_saned/v6_prefixes/' 
output_file = '19-preparing_data_for_plot/v6/prefixes/prefixes_announced_regions.txt'  
...
with open(output_file, 'w') as out:
    ...
    for file in sorted(os.listdir(input_folder)):
        if file.startswith('v6_prefixes_policies_complete') and file.endswith('.txt'):

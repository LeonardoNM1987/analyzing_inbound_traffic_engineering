...
def analyze_for_date(date):
    ...
    file3 = f'11-selective_announcement_results/v4/selective_announc_result_{date}.txt'  # Novo arquivo
    ...
    # Resultados
    result = f"{date}|{total_ases}|{total_aspp_and_more_specific}|{total_aspp_and_selective}|{total_more_specific_and_selective}|{total_all_three_modified}|{total_just_aspp}|{total_just_more_specific}|{total_just_selective}"
...
dates3 = list_dates(f'11-selective_announcement_results/v4', 'selective_announc_result_')

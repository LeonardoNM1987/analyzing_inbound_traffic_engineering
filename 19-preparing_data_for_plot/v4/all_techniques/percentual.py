...
input_file = "19-preparing_data_for_plot/v4/all_techniques/all_techniques_deploy.txt"  # Substitua pelo caminho do arquivo de entrada
output_file = "19-preparing_data_for_plot/v4/all_techniques/all_techniques_deploy_percentual.txt"  # Substitua pelo caminho desejado para o arquivo de saída

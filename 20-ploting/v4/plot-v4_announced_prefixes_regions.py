...
arquivo = '19-preparing_data_for_plot/v4/prefixes_announced_regions.txt'

# Ler o arquivo em um DataFrame
df = pd.read_csv(arquivo, sep='|', comment='#', header=0, names=["data", "internet", "afrinic", "arin", "apnic", "lacnic", "ripencc"])
...
#fig.suptitle('Prefixos IPv4 anunciados ao longo do tempo', fontsize=FONTSIZE_TITLE, fontweight='bold',y=0.95, x=0.53)
...
output_path = os.path.join(output_folder, f'v4_announced_prefixes_regions.png')

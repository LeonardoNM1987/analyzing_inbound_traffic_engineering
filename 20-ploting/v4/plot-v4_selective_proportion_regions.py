...
arquivo = '19-preparing_data_for_plot/v4/selective_proportion_regions.txt'
...
#fig.suptitle(f'Proporção de uso de Anúncio Seletivo dos ASes em seus prefixos - '+regiao.upper(), fontsize=FONTSIZE_TITLE, fontweight='bold',y=0.95, x=0.53)
...
output_path = os.path.join(output_folder, f'v4_selective_proportion_region_{regiao}.png')

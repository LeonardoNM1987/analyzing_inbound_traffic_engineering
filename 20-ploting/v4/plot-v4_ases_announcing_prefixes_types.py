...
arquivo = '19-preparing_data_for_plot/v4/ases_types.txt'
...
#fig.suptitle('ASes anunciando prefixos IPv4 de acordo com tipo', fontsize=FONTSIZE_TITLE, fontweight='bold',  y=0.95, x=0.53)
...
output_path = os.path.join(output_folder, f'v4_ases_announcing_prefixes_types.png')

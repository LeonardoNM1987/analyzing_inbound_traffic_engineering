...
def configurar_grafico(fig, ax):
    ...
    ax.set_ylim(0, 50)
    ax.set_yticks(np.arange(0, 51, 20))
...
arquivo = '19-preparing_data_for_plot/v4/aspp_intensity_types.txt'
...
#fig.suptitle(f'Tamanhos de prepend mais utilizados pelos ASes - {type} ', fontsize=FONTSIZE_TITLE, fontweight='bold',y=0.95, x=0.53)
...
output_path = os.path.join(output_folder, f'v4_aspp_intensity_types_{type}.png')

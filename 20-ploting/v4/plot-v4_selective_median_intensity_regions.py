...
arquivo = '19-preparing_data_for_plot/v4/selective_median_intensity_regions.txt'
...
#fig.suptitle(f'Classificação de ASes por Mediana de Intensidade de Seletividade dos /24 - '+regiao.upper(), fontsize=FONTSIZE_TITLE, fontweight='bold',y=0.95, x=0.53)
...
output_path = os.path.join(output_folder, f'v4_selective_median_intensity_region_{regiao}.png')

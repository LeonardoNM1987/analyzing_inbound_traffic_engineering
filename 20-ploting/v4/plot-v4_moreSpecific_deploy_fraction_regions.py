...
arquivo = '19-preparing_data_for_plot/v4/more_specific_deploy_regions.txt'
...
output_path = os.path.join(output_folder, f'v4_moreSpecific_deploy_fraction_regions.png')

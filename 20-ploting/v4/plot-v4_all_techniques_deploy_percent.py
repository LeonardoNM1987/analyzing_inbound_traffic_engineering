...
# Caminho do arquivo
arquivo = '19-preparing_data_for_plot/v4/all_techniques/all_techniques_deploy.txt'
...
# Calcular os percentuais em relação ao total_ases
columns_to_plot = [
    'all_three', 'aspp_and_moreSpecific', 'aspp_and_selective',
    'more_specific_and_selective', 'just_aspp', 'just_more_specific', 'just_selective'
]
for col in columns_to_plot:
    df[col] = (df[col] / df['total_ases']) * 100

# Configuração do eixo Y para valores percentuais
...
# Salvar o gráfico
output_path = '20-ploting/v4/plot_dissertacao/all_techs/v4_all_techniques_deploy_percentual.png'

...
arquivo = '19-preparing_data_for_plot/v4/moreSpecific_intensity_regions.txt'
...
output_path = os.path.join(output_folder, f'v4_moreSpecific_intensity_regions_{regiao}.png')

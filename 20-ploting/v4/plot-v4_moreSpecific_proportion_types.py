...
arquivo = '19-preparing_data_for_plot/v4/moreSpecific_proportion_types.txt'
...
#fig.suptitle(f'Proporção de uso de Prefixo mais Específico \nnos anúncios de cada tipo de AS - {tipo} ', fontsize=FONTSIZE_TITLE, fontweight='bold',y=0.95, x=0.53)
...
# ax.legend(
#     loc='upper center',
#     title='Proporção de prefixos que são mais específicos, para cada tipo AS',
#     title_fontsize=12,
...
output_path = os.path.join(output_folder, f'v4_moreSpecific_proportion_types_{tipo}.png')

...
def configurar_grafico(fig, ax1):
    ...
    ax1.set_ylabel('Número Absoluto de ASes com ASPP', fontsize=FONTSIZE_LABEL)
    ax1.set_ylim(Y_LIM)
...
output_path = os.path.join(output_folder, f'v4_moreSpecific_deploy_absolute_types.png')

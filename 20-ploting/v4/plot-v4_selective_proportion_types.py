...
arquivo = '19-preparing_data_for_plot/v4/selective_proportion_types.txt'
df = pd.read_csv(arquivo, sep='|')

# Filtrar dados para a região 'internet'
df_global = df[df['as_type'] == as_type]
...
#fig.suptitle(f'Proporção de uso de Anúncio Seletivo dos ASes em seus prefixos\n de acordo com o tipo de AS - '+as_type.upper(), fontsize=FONTSIZE_TITLE, fontweight='bold',y=0.95, x=0.53)
#ax.set_title(SUBTITLE, fontsize=FONTSIZE_SUBTITLE, pad=25)
...
output_path = os.path.join(output_folder, f'v4_selective_proportion_types_{as_type}.png')

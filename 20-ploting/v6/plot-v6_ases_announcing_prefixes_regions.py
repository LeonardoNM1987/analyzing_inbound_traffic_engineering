...
arquivo = '19-preparing_data_for_plot/v6/ases/ases_regions.txt'
...
#fig.suptitle('ASes anunciando prefixos IPv6 ao longo do tempo', fontsize=FONTSIZE_TITLE, fontweight='bold',  y=0.95, x=0.53)
...
output_path = os.path.join(output_folder, f'v6_ases_announcing_prefixes_regions.png')

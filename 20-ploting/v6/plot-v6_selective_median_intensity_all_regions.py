...
arquivo = '19-preparing_data_for_plot/v6/selective/selective_median_intensity_regions.txt'
...
output_path = os.path.join(output_folder, 'v6_selective_median_intensity_all_regions.png')

...
arquivo = '19-preparing_data_for_plot/v6/prefixes/prefixes_announced_regions.txt'
...
#fig.suptitle('Prefixos IPv6 anunciados ao longo do tempo', fontsize=FONTSIZE_TITLE, fontweight='bold',y=0.95, x=0.53)
...
output_path = os.path.join(output_folder, f'v6_prefixes_announced_regions.png')

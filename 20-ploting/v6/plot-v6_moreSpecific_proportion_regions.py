...
arquivo = '19-preparing_data_for_plot/v6/moreSpecific/moreSpecific_proportion_regions.txt'
...
output_path = os.path.join(output_folder, f'v6_moreSpecific_proportion_regions_{regiao}.png')

...
arquivo = '19-preparing_data_for_plot/v6/selective/selective_proportion_regions.txt'
...
output_path = os.path.join(output_folder, 'v6_selective_proportion_all_regions.png')

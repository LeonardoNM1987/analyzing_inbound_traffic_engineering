...
arquivo = '19-preparing_data_for_plot/v6/selective/selective_median_intensity_types.txt'
...
output_path = os.path.join(output_folder, f'v6_selective_median_intensity_types_{tipo}.png')

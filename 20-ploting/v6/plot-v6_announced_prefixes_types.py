...
def configurar_grafico(fig, ax1):
    ...
    ax1.set_ylabel('Prefixos IPv6', fontsize=FONTSIZE_LABEL)
    ax1.set_ylim(Y_LIM)
...
arquivo = '19-preparing_data_for_plot/v6/prefixes/prefixes_announced_types.txt'
...
#fig.suptitle('Prefixos IPv6 anunciados ao longo do tempo por tipo de AS', fontsize=FONTSIZE_TITLE, fontweight='bold',y=0.95, x=0.53)
...
output_folder = '20-ploting/v6/plot/prefixes'
output_path = os.path.join(output_folder, f'v6_prefixes_announced_types.png')

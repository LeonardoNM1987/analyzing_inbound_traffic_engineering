...
#data = pd.read_csv("19-preparing_data_for_plot/v6/all_techniques/all_tech_proportion_consolidated_data.txt")
data = pd.read_csv("19-preparing_data_for_plot/v6/all_techniques/all_tech_proportion_consolidated_data.txt")
...
# Salvar o gráfico
output_folder = '20-ploting/v6/plot/all_techs'
output_path = os.path.join(output_folder, f'v6_all_techniques_proportion_correlation.png')

...
arquivo = '19-preparing_data_for_plot/v6/moreSpecific/moreSpecific_proportion_types.txt'
...
output_path = os.path.join(output_folder, 'v6_moreSpecific_proportion_all_types.png')

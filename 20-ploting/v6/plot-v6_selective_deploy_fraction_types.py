...
arquivo = '19-preparing_data_for_plot/v6/selective/selective_deploy_types.txt'
...
output_path = os.path.join(output_folder, f'v6_selective_deploy_fraction_types.png')
